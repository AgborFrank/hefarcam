@if($seo)
    <meta name="title" Content="{{ $general->sitename(__($pageTitle ?? 'Bossman')) }}">
    ...
    <meta name="apple-mobile-web-app-title" content="{{ $general->sitename($pageTitle  ?? 'Bossman') }}">
    {{--<!-- Google / Search Engine Tags -->--}}
    <meta itemprop="name" content="{{ $general->sitename($pageTitle  ?? 'Bossman') }}">
